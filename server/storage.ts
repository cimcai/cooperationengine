...
export const availableChatbots: Chatbot[] = [
  ...
  },
  {
    ...
    description: "OpenAI's older GPT-3.5 Turbo via OpenRouter",
    enabled: true,
  },
  {
    id: "openrouter-gpt4",
    ...
    model: "openai/gpt-4",
    description: "OpenAI's original GPT-4 via OpenRouter",
    enabled: true,
  },
  {
    id: "openrouter-gpt4turbo",
    provider: "openrouter",
  ...
  {
    id: "legacy-claude3-opus",
    provider: "openrouter",
    displayName: "Claude 3 Opus (legacy)",
    model: "anthropic/claude-3-opus",
    description: "Retired by provider — no longer served",
    enabled: false,
  },
  {
    id: "legacy-claude3-sonnet",
    provider: "openrouter",
