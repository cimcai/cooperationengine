...
// Use an AI model to pick the single story where the recipient achieves the
// best outcome and creates the greatest positive impact. Falls back to the
// longest/richest story if ranking is unavailable or fails.
async function pickBestStory(
